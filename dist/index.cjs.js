...
var MappingProvider = function MappingProvider(_ref) {
  ...
  var groups = React.useRef([]).current;
...
var Mapping = function Mapping(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(MappingProvider, null, /*#__PURE__*/React__default['default'].createElement(MappingContext.Consumer, null, function (_ref3) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, groups.length ? /*#__PURE__*/React__default['default'].createElement(reactRouterDom.Switch, null, groups) : /*#__PURE__*/React__default['default'].createElement(Grouping, {
      prefix: "/"
    }, children));
  }));
};
...
var GroupingProvider = function GroupingProvider(_ref4) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(GroupingContext.Provider, {
    value: _objectSpread2({}, rest)
  }, children);
};

var Grouping = function Grouping(_ref5) {
  ...
  var _useContext = React.useContext(GroupingContext),
      ...
      groupLayout = _useContext.groupLayout;

  var Layout = layout || groupLayout || React.Fragment;
  var groupRoutes = React.useRef([]).current;
  React.useEffect(function () {
    var groupPath = [].concat(_toConsumableArray(prefixes), [prefix]).join('/').replace(/(\/+)/g, '/');
    context.groups.push( /*#__PURE__*/React__default['default'].createElement(reactRouterDom.Route, {
      key: groupPath,
      path: groupPath
    }, /*#__PURE__*/React__default['default'].createElement(Layout, null, /*#__PURE__*/React__default['default'].createElement(reactRouterDom.Switch, null, Object.values(groupRoutes)))));
  }, []);
...
var MapRoute = function MapRoute(_ref6) {
  var children = _ref6.children,
      name = _ref6.name,
      component = _ref6.component,
      _render = _ref6.render,
      as = _ref6.as,
      rest = _objectWithoutProperties(_ref6, ["children", "name", "component", "render", "as"]);
  ...
  var _useContext2 = React.useContext(GroupingContext),
      ...
      groupRoutes = _useContext2.groupRoutes;

  React.useEffect(function () {
    var path = Array.of(rest.path).flat().map(function (item) {
      return item ? "".concat([].concat(_toConsumableArray(prefixes), [item]).join('/').replace(/(\/+)/g, '/')) : null;
    }).filter(function (item) {
      return item;
    });
    var As = as || reactRouterDom.Route;
    var route = /*#__PURE__*/React__default['default'].createElement(As, _extends({}, rest, {
      key: path,
      name: name,
...
MapRoute.defaultProps = _objectSpread2({}, reactRouterDom.Route.defaultProps);
...
var useRoute = function useRoute() {
  ...
  var route = function route(name, params) {
    ...
    if (Object.keys(routes).length) {
      if (routes[name]) {
        var props = routes[name].props;
        var pathname = props.path[0];
