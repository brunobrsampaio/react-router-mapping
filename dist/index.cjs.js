...
var useMap = function useMap(routes) {
  var routesList = {};
  var recursiveRoutes = React.useCallback(function (list, previousPathname) {
    list.forEach(function (_ref) {
      ...
      if (name) {
        ...
        routesList[name] = /*#__PURE__*/React__default["default"].createElement(As, _objectSpread(_objectSpread({}, rest), {}, {
          key: path,
          path: customPath
        }));
      }
